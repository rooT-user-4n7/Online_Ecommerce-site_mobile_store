...
while($data= $result->fetch_assoc()){ ?>
		...
		<div class="main">
			<button  type="submit" class="btn btn-success btn-block"><a href='update.php?Product_ID=<?php echo $data['id']; ?>'><u>Update</u></a></button>
			<button  type="button" class="btn btn-danger"><a href='action.php?Product_ID=<?php echo $data['id']; ?>'><u>Delete</u></a></button>
		</div>
		</div>	
